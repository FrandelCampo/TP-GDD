...
--7 --> Aca se puede usar el campo tipo_operacion de la tabla bi_hechos_anuncio
--		para verificar si es alquiler o venta, y hacer un select para alquiler (con su comision)
--		y otro select para hechos venta. Entre cada Select poner un UNION ALL para juntar todos los resultados


IF OBJECT_ID('PIE_DERECHO.VISTA_PROMEDIO_COMISION', 'V') IS NOT NULL
    DROP VIEW PIE_DERECHO.VISTA_PROMEDIO_COMISION;
GO
...
SELECT * FROM PIE_DERECHO.VISTA_PORCENTAJE_INCUMPLIMIENTO_PAGOS --revisar
