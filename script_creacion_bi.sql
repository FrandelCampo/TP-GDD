...
--drop fks
IF OBJECT_ID('PIE_DERECHO.FK_LOCALIDAD_PROVINCIA_ID', 'F') IS NOT NULL
ALTER TABLE PIE_DERECHO.BI_LOCALIDAD
DROP CONSTRAINT FK_LOCALIDAD_PROVINCIA_ID;
GO

IF OBJECT_ID('PIE_DERECHO.FK_BARRIO_LOCALIDAD_ID', 'F') IS NOT NULL
ALTER TABLE PIE_DERECHO.BI_BARRIO
...
ALTER TABLE PIE_DERECHO.BI_BARRIO ADD CONSTRAINT FK_BARRIO_LOCALIDAD_ID FOREIGN KEY (LOCALIDAD_CODIGO) REFERENCES PIE_DERECHO.BI_LOCALIDAD(LOCALIDAD_CODIGO)
GO

ALTER TABLE PIE_DERECHO.BI_LOCALIDAD ADD CONSTRAINT FK_LOCALIDAD_PROVINCIA_ID FOREIGN KEY (PROVINCIA_CODIGO) REFERENCES PIE_DERECHO.BI_PROVINCIA(PROVINCIA_CODIGO)
GO
...
JOIN PIE_DERECHO.BI_TIPO_OPERACION tiop ON tiop.TIPO_OPERACION_DESCRIPCION = a.ANUNCIO_TIPO_OPERACION_CODIGO
...
SELECT
	...
	(SELECT TIPO_INMUEBLE_CODIGO
	 ...
	 (SELECT l.LOCALIDAD_CODIGO
	  ...
	  JOIN PIE_DERECHO.BI_BARRIO b ON b.LOCALIDAD_CODIGO = l.LOCALIDAD_CODIGO
