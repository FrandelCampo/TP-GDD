...
CREATE TABLE BI_INMUEBLES.BI_SUCURSAL(
	SUCURSAL_CODIGO INT IDENTITY PRIMARY KEY,
	SUCURSAL_NOMBRE nvarchar(100)
);
GO

CREATE TABLE BI_INMUEBLES.BI_BARRIO(
...
CREATE TABLE BI_INMUEBLES.BI_HECHOS_ANUNCIO(
...
CREATE TABLE BI_INMUEBLES.BI_HECHOS_ALQUILER(
...
CREATE TABLE BI_INMUEBLES.BI_HECHOS_VENTA(
...
ALTER TABLE BI_INMUEBLES.BI_HECHOS_ANUNCIO ADD CONSTRAINT FK_ANUNCIO_TIEMPO_ID FOREIGN KEY (tiempo) REFERENCES BI_INMUEBLES.BI_TIEMPO(TIEMPO_CODIGO)
GO

ALTER TABLE BI_INMUEBLES.BI_HECHOS_ANUNCIO ADD CONSTRAINT FK_ANUNCIO_TIPO_OPERACION_ID FOREIGN KEY (tipo_operacion) REFERENCES BI_INMUEBLE.BI_TIPO_OPERACION(TIPO_OPERACION_CODIGO)
GO

ALTER TABLE BI_INMUEBLES.BI_HECHOS_ANUNCIO ADD CONSTRAINT FK_ANUNCIO_BARRIO_ID FOREIGN KEY (barrio) REFERENCES BI_INMUEBLE.BI_BARRIO(BARRIO_CODIGO)
GO

ALTER TABLE BI_INMUEBLES.BI_HECHOS_ANUNCIO ADD CONSTRAINT FK_ANUNCIO_AMBIENTES_ID FOREIGN KEY (ambientes) REFERENCES BI_INMUEBLE.BI_AMBIENTES(AMBIENTES_CODIGO)
GO

ALTER TABLE BI_INMUEBLES.BI_HECHOS_ANUNCIO ADD CONSTRAINT FK_ANUNCIO_TIPO_INMUEBLE_ID FOREIGN KEY (tipo_inmueble) REFERENCES BI_INMUEBLE.BI_TIPO_INMUEBLE(TIPO_INMUEBLE_CODIGO)
GO

ALTER TABLE BI_INMUEBLES.BI_HECHOS_ANUNCIO ADD CONSTRAINT FK_ANUNCIO_RANGO_METROS_ID FOREIGN KEY (rango_metros) REFERENCES BI_INMUEBLE.BI_RANGO_METROS(RANGO_METROS_CODIGO)
GO

ALTER TABLE BI_INMUEBLES.BI_HECHOS_ANUNCIO ADD CONSTRAINT FK_ANUNCIO_TIPO_MONEDA_ID FOREIGN KEY (tipo_moneda) REFERENCES BI_INMUEBLE.BI_TIPO_MONEDA(TIPO_MONEDA_CODIGO)
GO

ALTER TABLE BI_INMUEBLES.BI_HECHOS_ANUNCIO ADD CONSTRAINT FK_ANUNCIO_SUCURSAL_ID FOREIGN KEY (sucursal) REFERENCES BI_INMUEBLE.BI_SUCURSAL(SUCURSAL_CODIGO)
GO

ALTER TABLE BI_INMUEBLES.BI_HECHOS_ANUNCIO ADD CONSTRAINT FK_ANUNCIO_RANGO_ETARIO_EMPLEADO_ID FOREIGN KEY (rango_etario_empleado) REFERENCES BI_INMUEBLE.BI_RANGO_ETARIO(RANGO_ETARIO_CODIGO)
GO

ALTER TABLE BI_INMUEBLES.BI_HECHOS_ALQUILER ADD CONSTRAINT FK_ALQUILER_RANGO_ETARIO_INQUILINO_ID FOREIGN KEY (rango_etario_inquilino) REFERENCES BI_INMUEBLE.BI_RANGO_ETARIO(RANGO_ETARIO_CODIGO)
GO

ALTER TABLE BI_INMUEBLES.BI_HECHOS_ALQUILER ADD CONSTRAINT FK_ALQUILER_TIEMPO_ID FOREIGN KEY (tiempo) REFERENCES BI_INMUEBLE.BI_TIEMPO(TIEMPO_CODIGO)
GO

ALTER TABLE BI_INMUEBLES.BI_HECHOS_ALQUILER ADD CONSTRAINT FK_ALQUILER_BARRIO_ID FOREIGN KEY (barrio) REFERENCES BI_INMUEBLE.BI_BARRIO(BARRIO_CODIGO)
GO

ALTER TABLE BI_INMUEBLES.BI_HECHOS_VENTA ADD CONSTRAINT FK_VENTA_TIEMPO_ID FOREIGN KEY (tiempo) REFERENCES BI_INMUEBLE.BI_TIEMPO(TIEMPO_CODIGO)
GO

ALTER TABLE BI_INMUEBLES.BI_HECHOS_VENTA ADD CONSTRAINT FK_VENTA_TIPO_INMUEBLE_ID FOREIGN KEY (tipo_inmueble) REFERENCES BI_INMUEBLE.BI_TIPO_INMUEBLE(TIPO_INMUEBLE_ID)
GO

ALTER TABLE BI_INMUEBLES.BI_HECHOS_VENTA ADD CONSTRAINT FK_VENTA_LOCALIDAD_ID FOREIGN KEY (localidad) REFERENCES BI_INMUEBLE.BI_LOCALIDAD(LOCALIDAD_CODIGO)
GO

ALTER TABLE BI_INMUEBLES.BI_HECHOS_VENTA ADD CONSTRAINT FK_VENTA_SUCURSAL_ID FOREIGN KEY (sucursal) REFERENCES BI_INMUEBLE.BI_SUCURSAL(SUCURSAL_CODIGO)
GO