...
INNER JOIN PIE_DERECHO.BI_TIEMPO fecha_pago_ini ON fecha_pago_ini.TIEMPO_ANIO = YEAR(ppa.PAGO_ALQUILER_FEC_INI)
										AND fecha_pago_ini.TIEMPO_MES = MONTH(ppa.PAGO_ALQUILER_FEC_INI)
										AND fecha_pago.TIEMPO_CUATRIMESTRE = PIE_DERECHO.FX_CALCULAR_CUATRIMESTRE(ppa.PAGO_ALQUILER_FEC_INI)
...
JOIN PIE_DERECHO.BI_TIPO_OPERACION b_tiop ON b_tiop.TIPO_OPERACION_DESCRIPCION = tiop.TIPO_OPERACION_ANUNCIO 
GROUP BY re.RANGO_ETARIO_CODIGO, bt_ini.TIEMPO_CODIGO, bt_fin.TIEMPO_CODIGO, fecha_pago.TIEMPO_CODIGO, fecha_pago_ini.TIEMPO_CODIGO, fecha_pago_venci.TIEMPO_CODIGO, ppa.PAGO_ALQUILER_IMPORTE, a.ALQUILER_COMISION, bi_ubi.UBICACION_CODIGO, bi_tm.TIPO_MONEDA_CODIGO, b_tiop.TIPO_OPERACION_CODIGO, bi_amb.AMBIENTES_CODIGO, bs.SUCURSAL_CODIGO, rm.RANGO_METROS_CODIGO, bi_bti.TIPO_INMUEBLE_CODIGO
END
GO
